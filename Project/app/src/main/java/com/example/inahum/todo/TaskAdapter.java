...
public class TaskAdapter extends ArrayAdapter<com.example.inahum.todo.Task> {
	Activity context;
    List<com.example.inahum.todo.Task> tasks;

	public TaskAdapter(Activity context, int resource, List<com.example.inahum.todo.Task> tasks) {
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        com.example.inahum.todo.Task t = getItem(position);
	...
	public List<com.example.inahum.todo.Task> getTasks() {
        return tasks;
    }
