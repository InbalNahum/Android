...
public class TaskUI extends Activity {
	...
	private ArrayList<com.example.inahum.todo.Task> tasks;
	private com.example.inahum.todo.Task task,newtask,edittask;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			 ...
			 public void onItemClick(AdapterView<?> parent, View view,
				 ...
				 index=position;
				 task=(com.example.inahum.todo.Task)listView.getItemAtPosition(position);
