...
public class ModifyTaskUI extends Activity {
	...
	private com.example.inahum.todo.Task task;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (action.equalsIgnoreCase("add")) 
				{			
					newtask=new com.example.inahum.todo.Task(descrtext.getText().toString(),spinner.getSelectedItem().toString(),dateFormat.format(new Date()),checkBox.isChecked());
					...
					edittask=new com.example.inahum.todo.Task(task.getId(),descrtext.getText().toString(),spinner.getSelectedItem().toString(),time,checkBox.isChecked());
