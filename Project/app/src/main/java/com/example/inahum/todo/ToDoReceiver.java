...
public class ToDoReceiver extends BroadcastReceiver {
	...
	com.example.inahum.todo.Task newtask,edittask;
		...
		Globalvars globalvars=Globalvars.getInstance();
				  ...
				  String msg = message.toString();
					...
					if (todo.equalsIgnoreCase("NEW")) {
						...
						Log.d(TAG,"Received msg with count " +newCount +" whereas my count is "+ com.example.inahum.todo.Task.getCount());
						//increment count if i am not in sync
						if (com.example.inahum.todo.Task.getCount() < newCount) {
							com.example.inahum.todo.Task.setCount(newCount);
						} 
						String desc=msgparts[2];
						newtask = new com.example.inahum.todo.Task(com.example.inahum.todo.Task.getCount(), desc,
								msgparts[3], msgparts[4], Boolean
								.valueOf(msgparts[5]));
						Log.d(TAG,"Adding task with count " + com.example.inahum.todo.Task.getCount()+1);
						...
						String desc=msgparts[2];
						edittask = new com.example.inahum.todo.Task(Integer.valueOf(msgparts[1]),
